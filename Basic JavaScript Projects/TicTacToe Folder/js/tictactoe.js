...
let selectedSquares = [];
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        function arrayincludes(squareA, squareB, squareC) {
         ...
         function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
            ...
            //This line indicates wehre the start of a lines x axis is. 
            let x1=coordX1,
                //This line indicates where the start of a lines y axis is. 
                y1=coordY1,
                //This lines indicates wehr ethe end of a lines x axis is.
                x2=coordX2,
                //This line indicaes where the end of al ines x axis is. 
                y2=coordY2,
        ...
        if (x1 <= x2 && y1 >= y2) {  
         ...
         function clear() { 
            ...
            const animationloop = requestAnimationFrame(clear); //This line clears our canvas. 
            c.clearRect(0, 0, 608, 608);
    ...
    function resetGame(){
        for (let i=0; i<9; i++) {
            ...
            //This removes our selements backgraoudImage.
            square.style.backgrounImage ='';
        }
